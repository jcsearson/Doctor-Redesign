...
<?php get_header(); ?>
	...
	<section class="main-info-upper main-info" role="region">
		...
		<p>At the first visit, please bring along a copy of your child's vaccination records and health insurance cards.  Please also arrange transfer of medical records when possible.  A parent or legal guardian must sign a consent for 'release of medical records’, which should be sent to the current provider, in order to arrange this transfer.  Many insurance companies will require you to inform them of a change in primary care provider.  Please ensure that this is done if required, to avoid billing issues.</p>
