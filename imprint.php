...
<?php get_header(); ?>
	...
	<section class="main-info-upper main-info" role="region">
		<h2>Imprint Page:</h2>
		<p>The following attributions are being aknowledged as to the design and development of this website.  If you have any questions related to the legal implications of what is seen on <a href="http://drstevencaplan.com/" target="_blank">this site</a> please contact the <a href="http://searsino.com/" target="_blank">developer</a>.</p>
